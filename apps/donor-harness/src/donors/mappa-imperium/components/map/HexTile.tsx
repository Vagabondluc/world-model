...
import { HexCoordinate, BiomeType, TileTheme, OutlineStyle } from '@mi/types';
import { BIOME_CONFIG } from '@mi/data/biomeData';
...
const BIOME_TILE_MAP: Record<BiomeType, { row: number, col: number }> = {
    ...
    planar: { row: 3, col: 1 },
    plains: { row: 0, col: 0 }, // uses grassland tile
    water: { row: 1, col: 2 },  // uses ocean tile
};
