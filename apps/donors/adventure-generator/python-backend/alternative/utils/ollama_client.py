...
class OllamaClient:
    ...
    def __init__(self, model: Optional[str] = None, base_url: Optional[str] = None) -> None:
        ...
        self.base_url: str = base_url or ollama_config.get("base_url", "http://localhost:11434")
        self.model: str = model or ollama_config.get("default_model", "gpt-oss:20b")
        self.timeout: int = ollama_config.get("timeout", 300)
