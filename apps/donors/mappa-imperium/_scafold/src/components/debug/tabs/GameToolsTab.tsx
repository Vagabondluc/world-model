...
const GameToolsTab: React.FC<Omit<UnifiedDebugSystemProps, 'isOpen' | 'onClose'>> = ({
    onPrepopulateEra,
    onUnlockAllEras,
    onExportGameData,
    onImportGameData,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-2">
                            {[1, 2, 3, 4, 5, 6].map(era => (
                                <button key={era} onClick={() => onPrepopulateEra(era, selectedPlayerNumber)} className="w-full bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700 text-sm flex items-center justify-center gap-1">
