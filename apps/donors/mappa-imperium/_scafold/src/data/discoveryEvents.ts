...
export const discoveryEvents: Record<number, DiscoveryEvent> = {
    ...
    14: {
        ...
        prompt: `A neighboring faction is expanding. Detail their new settlement's distinctive features, two ways it affects your interests, one opportunity for cooperation, and potential future conflicts.`,
        elementType: 'Event',
    },
    15: {
        name: 'New Resource',
    ...
    17: {
        ...
        prompt: `Unique creatures roam your territories. Specify their distinctive features and behaviors, three potential resources they provide (hides, meat, magical components, etc.), one challenge they present, and their impact on local development.`,
        elementType: 'Resource',
    },
    18: {
