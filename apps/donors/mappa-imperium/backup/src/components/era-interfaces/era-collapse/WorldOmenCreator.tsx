        ...
        <div className="space-y-6">
            ...
            {rolledOmen && (
                <form onSubmit={handleSubmit} className="p-6 border rounded-lg bg-white shadow-sm space-y-4 animate-fade-in-slide-up">
                    ...
                    <div>
                        <label htmlFor="omen-desc" className={componentStyles.form.label}>Describe its manifestation and meaning</label>
                        <textarea id="omen-desc" value={formState.description} onChange={e => setFormState(p => ({...p, description: e.target.value}))} required rows={8} className={componentStyles.input.base} />
                    </div>

                    <AIGenerationSection title="AI-Powered Generation">
                        <button type="button" onClick={handleGenerate} disabled={isLoading} className={cn(componentStyles.button.base, componentStyles.button.primary, "w-full bg-blue-600 hover:bg-blue-700")}>
                    ...
                    <div className="pt-4 border-t">
                        <button type="submit" disabled={!formState.description} className={cn(componentStyles.button.base, componentStyles.button.primary, "w-full")}>
