    ...
    return (
        <div className="space-y-4 p-6 border rounded-lg bg-white shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-4">
                <div>
                    <label htmlFor="neighbor-select" className={componentStyles.form.label}>1. Select Neighbor</label>
                    <select
                        id="neighbor-select"
                ...
                {selectedNeighbor && (
                    <div>
                        <label htmlFor="neighbor-type-select" className={componentStyles.form.label}>2. Confirm Neighbor Type</label>
                        <select
