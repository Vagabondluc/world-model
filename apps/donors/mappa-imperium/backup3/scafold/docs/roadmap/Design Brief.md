...
- [ ] **DiscoveryEventSystem**: Dynamic form system using `/docs/ai-templates/events/era-4/` specifications.
- [ ] **EmpireEventSystem**: Dynamic form system using `/docs/ai-templates/events/era-5/` specifications.
- [ ] **CollapseNarrativeSystem**: Dynamic form system using `/docs/ai-templates/events/era-6/` specifications.
- [ ] **BattleChronicleSystem**: Dynamic form system using the specification in `/docs/ai-templates/events/` for War events.
