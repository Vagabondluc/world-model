...
const ConsoleTab: React.FC<ConsoleTabProps> = ({ consoleEntries, addEntry, clearConsole }) => {
    ...
    return (
        <div className="flex flex-col h-full">
          <div className="flex-shrink-0 bg-white border rounded-t-lg p-4">
            <div className="flex justify-between items-center">
              <h4 className="font-semibold text-gray-900">Console Log</h4>
              <div className="text-xs text-gray-500">
                Entries: {consoleEntries.length} | Auto-scroll: On
              </div>
            </div>
          </div>
          
          <div ref={consoleRef} className="flex-1 bg-gray-800 text-white font-mono text-xs p-4 rounded-b-lg overflow-y-auto">
