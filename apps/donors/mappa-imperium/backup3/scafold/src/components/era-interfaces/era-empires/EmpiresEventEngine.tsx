                        ...
                        <form onSubmit={handleCreateElement} className="space-y-4">
                            <div className="grid md:grid-cols-3 gap-4">
                                <div className="md:col-span-2">
                                    <label htmlFor="element-name" className="block text-sm font-medium text-gray-700">Event Title</label>
                             ...
                             <div>
                                <label htmlFor="narrative-edit" className="block text-sm font-medium text-gray-700">Event Chronicle</label>
                            ...
                            <div className="flex gap-4 pt-4 border-t">
                                <button type="submit" disabled={!formState.name || typeof formState.year !== 'number' || !!yearError} className="w-full bg-amber-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-amber-700 shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed">Create Event & Complete Turn</button>
                            </div>
