      ...
      <div className="container mx-auto flex flex-col gap-4">
        <div className="flex justify-between items-center">
            <div className="flex items-center gap-4">
                ...
                {currentYearDisplay && (
                    <div className="pill-badge" title="Current approximate year based on your progress in the viewed era.">
                        {currentYearDisplay}
                    </div>
                )}
            </div>
            ...
            <nav className="nav-container">
                <button 
                    ...
                    className={`nav-button ${view === 'eras' ? 'nav-button-active' : 'nav-button-inactive'}`}
                ...
                <button 
                    ...
                    className={`nav-button ${view === 'elements' ? 'nav-button-active' : 'nav-button-inactive'}`}
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative" ref={exportMenuRef}>
                    <button 
                        ...
                        className="hidden md:inline-flex items-center gap-2 btn btn-secondary bg-amber-700 hover:bg-amber-600 text-white"
                        aria-haspopup="true"
                    ...
                    {isExportMenuOpen && (
                        <div className="dropdown-menu top-full right-0 mt-2 w-56 animate-fade-in-down" role="menu">
                             <button
                                role="menuitem"
                 ...
                 <button 
                    ...
                    className="btn-icon bg-amber-700 hover:bg-amber-600 focus:ring-amber-300"
                ...
                >
                 ...
                 {isDebugMode && (
                    <button 
                        ...
                        className="btn-icon bg-red-600 hover:bg-red-500 focus:ring-red-300"
