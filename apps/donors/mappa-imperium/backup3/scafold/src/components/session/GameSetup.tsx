    ...
    return (
        <div className="layout-centered-card">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {gameLengths.map((len) => (
                                <button
                                    ...
                                    className={`btn-toggle ${length === len ? 'btn-toggle-active' : ''}`}
                                >
                                    {len}
                                </button>
                            ))}
                    ...
                    <div className="mb-10">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <button
                                ...
                                className="btn-icon bg-gray-200 hover:bg-gray-300 text-gray-600"
                ...
                <div className="space-y-4">
                     <div className="grid grid-cols-2 gap-4">
                        <button
                            ...
                            className="w-full btn btn-secondary bg-sky-800 hover:bg-sky-700 text-white flex items-center justify-center gap-2"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                         ...
                         <button
                            ...
                            className="w-full btn btn-secondary bg-gray-600 text-white hover:bg-gray-700 flex items-center justify-center gap-2"
                    ...
                    <form onSubmit={handleFeedSubmit}>
                        <div className="flex gap-2">
                            ...
                            <button
                                type="submit"
                                className="btn btn-primary bg-sky-700 hover:bg-sky-600"
                            >
                                Load
                            </button>
                        </div>
            ...
            {onDebug && (
                 <button
                    onClick={onDebug}
                    className="fixed bottom-4 right-4 btn btn-destructive flex items-center gap-2"
