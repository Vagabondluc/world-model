...
import type { PlayerSelectionProps, Player } from '../../types';

const PlayerSelection = ({ players, onSelect, onJoinAsObserver }: PlayerSelectionProps) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (nameToSend && passwordToSend) {
            onSelect(selectedPlayer.playerNumber, nameToSend, passwordToSend);
        }
    };
            ...
            <div className="page-card max-w-2xl">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button
                        ...
                        className="w-full mt-8 btn btn-primary disabled:bg-gray-400 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none"
                    >
                ...
                <button
                    onClick={onJoinAsObserver}
                    className="w-full btn btn-primary bg-gray-600 hover:bg-gray-700"
                >
                    Join as Observer
                </button>
            </div>
