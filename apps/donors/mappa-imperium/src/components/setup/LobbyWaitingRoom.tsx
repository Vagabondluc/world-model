                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <div className="flex-1 bg-white flex flex-col">
                        <div className="flex-1 p-6 overflow-y-auto space-y-4">
                            {chat.map((msg, i) => (
                                <div key={i} className={cn("flex flex-col", msg.sender === 'System' ? "items-center" : "items-start")}>
                                    {msg.sender === 'System' ? (
                                        <span className="bg-stone-100 text-stone-500 text-xs px-2 py-1 rounded-full">{msg.message}</span>
                                    ) : (
                                        <div className="max-w-[80%]">
                                            <span className="text-xs text-gray-400 ml-1">{msg.sender}</span>
