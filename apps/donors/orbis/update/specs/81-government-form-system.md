# 🔒 GOVERNMENT FORM SYSTEM SPEC v1 (FROZEN)
...
- `Owns`: [`GovernmentFormIdV1`, `PowerCenterKeyV1`, `LegitimacySourceKeyV1`, `InstabilityTriggerMetricKeyV1`, `FactionAccessKeyV1`, `GovernmentKernelV1`]
- `Writes`: [`government form state outputs`]

## Canonical Owner
- `CANONICAL_OWNER`: `docs/specs/70-governance-benchmarks/81-government-form-system.md`
- `STATUS`: `FROZEN`
...
- all listed instability keys must exist in `docs/specs/30-runtime-determinism/56-unified-parameter-registry-schema-contract.md`
