# 96 Civil War Fragmentation Simulator (Brainstorm Draft)
...
- `Owns`: [`civil war and fragmentation contract`, `authority-split mechanics`]
- `Writes`: [`fragmentation and claimant-state outputs`]

## Canonical Owner
- `CANONICAL_OWNER`: `docs/brainstorm/96-civil-war-fragmentation-simulator.md`
