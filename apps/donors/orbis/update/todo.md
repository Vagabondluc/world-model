...
## Phase 26: Temporal Stability & Visual Gating (Planned)
**Goal:** Fix day length calculation and decouple visualization frame rate from simulation speed to prevent high-speed strobing.
- [ ] **26.1 Visual Regime Contract** (`docs/specs/60-projection-performance/70-temporal-stability-visual-gating.md`)
- [ ] **26.2 Day Length Logic Fix** (`components/globe/CelestialSystem.tsx`)
- [ ] **26.3 Performance Monitor** (`components/PerformanceMonitor.tsx`)

---
**Next Steps:**
1. Implement Phase 26 specs.
