  ...
  return (
    <div className="panel-body mode-surface">
      <section className="hero donor-hero">
        ...
        <p>Use the same canonical bundle to inspect donor-faithful or donor-derived surfaces next to the public product.</p>
      ...
      <section className="card-grid">
        ...
        {DONOR_ORDER.map((donor) => {
          ...
          return (
            <article key={donor} className="card donor-card">
              ...
              <NavLink to={definition.route} className="nav-link nav-family">
                <span>Open {definition.label}</span>
                <span className="nav-meta">{definition.sourceStatus}</span>
              </NavLink>
            </article>
          );
        })}
